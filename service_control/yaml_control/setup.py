...
import logging
import os
from service_control.logs_control.setup import yaml_control_logger
...
def get_base_url(key="default"):
    ...
    return base_urls.get(key, base_urls.get("xuanzheng", "https://192.168.1.20"))  # 优先使用 `key`，否则使用 `default`
